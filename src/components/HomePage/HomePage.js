    ...
    return (
        <React.Fragment>
            <div className="home-content">
                ...
                {props.isDesktop ?  <div className="main-videos">
                                        {videos.slice(0, 5).map((video, _, arr) => <video   className="main-videos__video" 
                                                                                            src={video} 
                                                                                            muted 
                                                                                            autoPlay
                                                                                            key={video}
                                 ...
                                 :  <div className="main-videos">
                                        {videos.slice(0, 1).map((video, _, arr) => <video   className="main-videos__video"
                                                                                            src={video} 
                                                                                            autoPlay
                                                                                            muted 
                                                                                            key={video}
