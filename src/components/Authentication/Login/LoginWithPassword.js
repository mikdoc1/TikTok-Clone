...
const LoginWithPassword = (props) => {
  ...
  return (
    <div style={{ width: '40.5rem' }}>
      ...
      <form
        className="login-form__body-top"
      ...
      >
        <div className="login-form__body-top-title" style={{ margin: '1rem 0' }}>
          ...
          <button
            onClick={() => context.passwordPageHandler()}
            className="title-smallest login-form__body-top-login-text"
          >
            Log in with phone
          </button>
        </div>
        <div className="email-password-input-wrapper">
          <input
            type="email"
            onChange={(e) => props.codeInputHandler(e)}
            value={email}
            className="input form-trending__input"
          ...
          <input
            ...
            value={password}
            ref={inputRef}
            className="input form-trending__input password-input"
          ...
          <img
            src={
              showPassword
                ? 'http://s16.tiktokcdn.com/falcon/fe_tiktok_common/svgs/showPassword.6f254a34.svg'
        ...
        <button className="login-form__body-top-login-text" style={{ fontSize: '1.2rem' }}>
          Forgot password?
        </button>
      </form>
      <button className={props.loginBtnClass.join(' ')} style={{ width: '100%', marginTop: '3rem' }}>
        Login
      </button>
      ...
      <div className="login-form__body-bottom-wrapper">
        <div className="login-form__body-bottom-signup-text-wrapper">
          <div className="login-form__body-bottom">
            ...
            &nbsp;
            <button className="sign-up-button" onClick={() => context.loginSignUpToggler()}>
              Sign up
            </button>
          </div>
        </div>
