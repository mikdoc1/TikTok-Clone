    ...
    return (
        ...
        <div className="user__header">
            <div className="user__info-description explore__col-img-wrapper">
                <div className="user__avatar explore__col-img" style={{backgroundImage: `url(${avatar})`, width: '120px', height: '120px', backgroundSize: 'cover'}}>
                {(playInfo[audioUrl].isPlaying) ?  <>  
                    ...
                    <audio id={audioUrl} className="audio-player" src={audioUrl} ref={audioRef} onPlay={() => onMusicStartPlay(audioUrl)}
                                                                                  onPause={() => {
                ...
                <div className="user__text">
                    ...
                    <h2 className="title title_black_bold user__text-subtitle" style={{fontSize: '2rem'}}>{smallText}</h2>
