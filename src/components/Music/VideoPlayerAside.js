...
const VideoPlayerAside = ({ musicData, index }) => {
    console.log(musicData)
    return (
        <div className="video-player__aside">
            <div className="user-info-container"> 
                <div className="user-info">
                    <RecommendListItem  src={musicData[index].avatar}
                                        title={musicData[index].username}
                                        subtitle={musicData[index].name}>
            ...
            <div className="video-info-container">
                <h1 className="title title_black">{musicData[index].title}</h1>
                <h2><Link className="title-medium-big title-medium-big_bold song-name" to="#">{musicData[index].song}</Link></h2>
                <div className="action-container">
                    <div className="action-left">
                        <span className="action-left__like">
                            <span className="like-icon"></span>
                            <strong className="like-text">{musicData[index].likes}</strong>
                        </span>
                        <span className="action-left__comment">
                            <span className="comment-icon"></span>
                            <strong className="comment-text">{musicData[index].comments}</strong>
                        </span>
                    </div>
