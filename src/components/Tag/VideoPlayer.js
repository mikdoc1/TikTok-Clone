...
import { playToggler, prevVideo, nextVideo, closePlayer, muteToggler } from '../../actions/tag';
...
const VideoPlayer = ({ 
    ...
    return (
        <div className="video-player">
            ...
            <VideoPlayerAside   tagData={tagData.videosInfo}
                                index={index}/>
...
const mapStateToProps = state => {
    return {
        ...
        index: state.tag.openedVideoIndex,
        isPlaying: state.tag.isPlaying,
        isMuted: state.tag.isMuted,
    }
}
