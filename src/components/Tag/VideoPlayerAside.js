...
const VideoPlayerAside = ({ tagData, index }) => {
    return (
        <div className="video-player__aside">
            <div className="user-info-container"> 
                <div className="user-info">
                    <RecommendListItem  src={tagData[index].avatar}
                                        title={tagData[index].username}
                                        subtitle={tagData[index].name}>
            ...
            <div className="video-info-container">
                <h1 className="title title_black">{tagData[index].title}</h1>
                <h2><Link className="title-medium-big title-medium-big_bold song-name" to="#">{tagData[index].song}</Link></h2>
                <div className="action-container">
                    <div className="action-left">
                        <span className="action-left__like">
                            <span className="like-icon"></span>
                            <strong className="like-text">{tagData[index].likes}</strong>
                        </span>
                        <span className="action-left__comment">
                            <span className="comment-icon"></span>
                            <strong className="comment-text">{tagData[index].comments}</strong>
                        </span>
                    </div>
