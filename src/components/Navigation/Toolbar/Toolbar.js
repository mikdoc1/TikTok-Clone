          ...
          <header className="header__content">
            <div className="hamburger-wrapper">
              <div className="hamburger-menu-wrapper">
                <Toggler isOpen={props.isOpen} openSidebar={props.openSidebar} closeSidebar={props.closeSidebar} />
              </div>
              <div className="logo-container">
                <Logo pathname={pathname} closeSidebar={props.closeSidebar} />
              </div>
            </div>
            {menu}
            <Button pathname={pathname} />
          </header>
          <SideDrawer isOpen={props.isOpen} openSidebar={props.openSidebar} closeSidebar={props.closeSidebar} />
        </div>
      )}
