...
const SignUp = (props) => {
    ...
    if(!context.loginWithPhone) {
        ...
        LoginPhoneOrEmail = <SignUpWithPhoneOrEmail onLoginWithPhoneNumber={props.onLoginWithPhoneNumber} response={props.resonse}/>
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(withAuthWithPhoneNumber(SignUp));