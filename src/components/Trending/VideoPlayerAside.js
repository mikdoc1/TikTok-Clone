...
const VideoPlayerAside = ({ usersData, index }) => {
    return (
        <div className="video-player__aside">
            <div className="user-info-container"> 
                <div className="user-info">
                    <RecommendListItem  src={usersData[index].user.avatar}
                                        title={usersData[index].user.username}
                                        subtitle={usersData[index].user.name}>
            ...
            <div className="video-info-container">
                <h1 className="title title_black">{usersData[index].title}</h1>
                <h2><Link className="title-medium-big title-medium-big_bold song-name" to="#">{usersData[index].song}</Link></h2>
                <div className="action-container">
                    <div className="action-left">
                        <span className="action-left__like">
                            <span className="like-icon"></span>
                            <strong className="like-text">{usersData[index].likes}</strong>
                        </span>
                        <span className="action-left__comment">
                            <span className="comment-icon"></span>
                            <strong className="comment-text">{usersData[index].comments}</strong>
                        </span>
                    </div>
