        ...
        <div className="video-player">
            <div className="video-player__content">
                <div className="bg-image-container">
                    <img src={usersData[index].preview} alt="bg" className="bg-image-container__image"/>    
                </div>
                <div className="video-container">
                    <video src={usersData[index].videoURL} className="video-container__video" loop autoPlay muted={isMuted} ref={videoRef}></video>
                ...
                {index !== usersData.length - 1 && <img className="player__right-arrow" onClick={() => onNextVideo(usersData, index)} src="//s16.tiktokcdn.com/tiktok/falcon/_next/static/images/arrow-c26566a07694be4e19165eb102ca9b29.svg" alt="right arrow"/>}
            ...
            <VideoPlayerAside   usersData={usersData}
                                index={index}/>
...
const mapStateToProps = state => {
    return {
        ...
        index: state.trending.openedVideoIndex,
        isPlaying: state.trending.isPlaying,
        isMuted: state.trending.isMuted,
    }
}
