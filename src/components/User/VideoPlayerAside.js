...
const VideoPlayerAside = ({ userData, index }) => {
    return (
        <div className="video-player__aside">
            <div className="user-info-container"> 
                <div className="user-info">
                    <RecommendListItem  src={userData.user.avatar}
            ...
            <div className="video-info-container">
                <h1 className="title title_black">{userData.videos[index].title}</h1>
                <h2><Link className="title-medium-big title-medium-big_bold song-name" to="#">{userData.videos[index].song}</Link></h2>
                <div className="action-container">
                    <div className="action-left">
                        <span className="action-left__like">
                            <span className="like-icon"></span>
                            <strong className="like-text">{userData.videos[index].likes}</strong>
                        </span>
                        <span className="action-left__comment">
                            <span className="comment-icon"></span>
                            <strong className="comment-text">{userData.videos[index].comments}</strong>
                        </span>
                    </div>
